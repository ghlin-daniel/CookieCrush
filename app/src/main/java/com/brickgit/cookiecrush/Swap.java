...
public class Swap {
	public final static int SWAP_ORIENTATION_HORIZONTAL = 0;
	public final static int SWAP_ORIENTATION_VERTICAL = 1;
	...
	public String toString() {
		return "Swap " + orientation + " (" + fromCookie.coord.row + ", " + fromCookie.coord.column + ") -> (" + toCookie.coord.row + ", " + toCookie.coord.column + ")";
	}
